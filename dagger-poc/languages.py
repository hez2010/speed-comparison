...
LANGUAGES: dict[str, Language] = {
    ...
    "csharp": Language(
        name="C#",
        nix_flake=(nix_pkg("dotnet-sdk_10"),),
        nix_flake_version="10.0.101",
        file="leibniz.cs",
        compile="dotnet new console -n leibniz -o _build --force && cp leibniz.cs _build/Program.cs && cd _build && dotnet publish -c Release -o ../out -p:PublishAot=true -p:OptimizationPreference=Speed -p:IlcInstructionSet=native -p:IlcMaxVectorTBitWidth=512",
        run="./out/leibniz",
    ...
    "csharp-simd": Language(
        ...
        compile="dotnet new console -n leibniz -o _build --force && cp leibniz-simd.cs _build/Program.cs && cd _build && dotnet publish -c Release -o ../out -p:PublishAot=true -p:OptimizationPreference=Speed -p:IlcInstructionSet=native -p:IlcMaxVectorTBitWidth=512",
        run="./out/leibniz",
        version_cmd="dotnet --version",
        base="csharp",
        category="dotnet",
    ...
    "fsharp": Language(
        ...
        nix_flake_version="10.0.101",
        file="fs/Program.fs",
        compile="cd fs && dotnet publish -c Release -o ../out -p:PublishAot=true -p:OptimizationPreference=Speed -p:IlcInstructionSet=native -p:IlcMaxVectorTBitWidth=512",
        run="./out/leibniz",
        version_cmd="dotnet --version",
        base="fsharp",
        category="dotnet",
